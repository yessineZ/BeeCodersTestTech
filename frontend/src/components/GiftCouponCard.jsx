...
const GiftCouponCard = () => {
	...
	return (
		...
		>
            ...
            p-2.5 text-sm text-white placeholder-gray-400 focus:border-pink-800 
            focus:ring-pink-900'
				...
				<motion.button
					type='button'
					className='flex w-full items-center justify-center rounded-lg bg-pink-900 px-5 py-2.5 text-sm font-medium text-white hover:bg-pink-800 focus:outline-none focus:ring-4 focus:ring-pink-800'
